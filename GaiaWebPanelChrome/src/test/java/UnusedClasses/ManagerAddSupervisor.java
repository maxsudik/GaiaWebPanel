...
public class ManagerAddSupervisor {
    ...
    public void Create() {
        ...
        //Find Supervisor MI
        element = ((ChromeDriver) driver).findElementByXPath("//option[@value='supervisor']");
